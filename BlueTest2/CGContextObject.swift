...
class CGContextObject: NSObject {
    ...
    func drawString(string:NSString,point:CGPoint,attribute:Dictionary<String,Any>){
        string.draw(at: point, withAttributes:  attribute)
    }
    //将string绘制在制定的区域
    func drawString(string:NSString,rect:CGRect,attribute:Dictionary<String,Any>){
